...
type
  TfFormPlant = class(TfBgFormBase)
...
procedure ShowViewPlantForm(const nID: string; const nRect: TRect);
//入口函数
...
procedure TfFormPlant.BtnExitClick(Sender: TObject);
begin
  inherited;
  CloseForm;
end;
